...
The expected pattern of \ac{a}~> \ac{c}~> \ac{b} based on the statistical model coefficients for segmental donor is seen in the relative magnitudes of repulsive force, but not in the magnitudes of mean cluster size.  % TODO: plot of cluster size, explain why it doesn't track segDonor
