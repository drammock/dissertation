...
A variety of studies have examined the linguistic dimensions that might be predictive of speech intelligibility in noise.  Unfortunately, it is hard to find a consensus in the literature: the predictors tested and the significance reported are not consistent across studies.  This section first reviews past findings on intelligibility as it relates to four commonly measured acoustic dimensions of speech: duration, intensity, vowel formant frequencies, and pitch.  This is followed by a discussion of segmental features and cues, particularly as related to the phenomena of clear speech, speech reduction, and Lombard effects.  Next, these dimensions of speech are related to talker characteristics such as gender, dialect, sociolect, and foreign accent.  The section concludes with a brief discussion of listener physiology, focusing on peripheral hearing loss and age-related cognitive decline, with brief mention of specific language impairment (SLI) and central auditory processing disorder (CAPD).

\subsection{Acoustic dimensions of speech}
In this section blah blah blah static measures of the speech signal.
...
vowel durations and intensities \cite[e.g.,][]{BondMoore1994}
...
Much research supports the idea that intelligibility is linked to properties of the F2×F1 vowel space \citep[e.g.,][]{BondMoore1994, BradlowEtAl1996, HazanMarkham2004, Neel2008}, though precisely which properties of the vowel space correlate with intelligibility are not consistent across studies.

\subsection{Segmental cues}
presence of stop release bursts \citep[e.g.,][]{PichenyEtAl1986, LiLoizou2008}
