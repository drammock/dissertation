...
\usepackage{natbib, graphicx, xcolor, url, fontspec, ragged2e, setspace, paralist, float, array, longtable, tabu, booktabs, multicol, multirow, titling, etoolbox}  % \setuldepth{x} siunitx 
...
% fonts & formatting
\setmainfont[Numbers={Lining}]{Linux Libertine O} \setmonofont{Source Sans Pro} %\setmonofont{Linux Libertine Mono O}
