...
%\usepackage[inline]{enumitem} % using paralist instead
...
\usepackage{natbib, graphicx, xcolor, url, fontspec, ragged2e, setspace, paralist, float, array, longtable, tabu, booktabs, multicol, multirow, titling, amsmath, etoolbox}  % \setuldepth{x} siunitx 
