...
\begin{table}[tb]
	...
	\begin{tabu}{XXX}
		\toprule
		\rowfont[c]{\bfseries} Talkers & Mean \ac{rmse} (Hz) & St. dev. \ac{rmse}\\
		\midrule
		Talkers \ac{a} \& \ac{b} & 12.4 & 3.9 \\
		Talkers \ac{a} \& \ac{c} & 15.4 & 6.1 \\
		Talkers \ac{b} \& \ac{c} & 16.6 & 5.9 \\
		\bottomrule
	\end{tabu}
\end{table}
