...
% a single shell call to BatchResynth.py with the long folder path arguments pre-specified.

LTASNoise.praat
% calculate long-term average spectrum of a corpus of sound files, and make some random noise that is spectrally shaped to match the corpus LTAS, and is longer than the longest stimulus in the corpus (to ensure complete masking). 

MixSpeechNoise.praat
% mix speech and noise at the desired SNR.

RampEdges.praat
% apply a linear amplitude ramp at beginning and end of file.
